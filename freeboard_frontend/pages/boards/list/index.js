    ...
    return (
        <Wrapper>
                ...
                <BestPostItem>
                    ...
                    <BestPostContentsWrapper>
                        ...
                        <BestPostContentsInfo>
                            <div>
                                <BestPostContentsProfile>
                                    <img src="/images/img_profile_small.png" alt="프로필이미지" width={20} height={20}/>
            ...
            <div>
                ...
                <div>
                    <div>
                        <button type="button"><span className="hidden">이전</span></button>
                        <button type="button">1</button>
                        <button type="button">2</button>
                        <button type="button"><span className="hidden">다음</span></button>
                    </div>
