...
export default function StaticRoutingPage() {
    ...
    return (
        <div>
            <button type="button" onClick={onClickMove1}>1번 게시글로 이동하기</button>
            <button type="button" onClick={onClickMove2}>2번 게시글로 이동하기</button>
            <button type="button" onClick={onClickMove3}>3번 게시글로 이동하기</button>
        </div>
    )
}